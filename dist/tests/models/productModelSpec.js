...
describe("product model", function () {
    ...
    describe("test model methods", function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            return [3 /*break*/, 4];
                        case 4:
                            expect(errMessage).toEqual("could not create new product. Error: product is already exist!");
                            return [2 /*return*/];
                    }
                });
            }); });
        ...
        describe("show method", function () {
            it("should return the right product", function () { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            return [3 /*break*/, 4];
                        case 4:
                            expect(errMessage).toEqual("could not get product, Error: you should provide existing id");
                            return [2 /*return*/];
                    }
                });
            }); });
